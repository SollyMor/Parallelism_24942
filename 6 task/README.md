...
```bash
./build/heat_conduction --size 256 --eps 1e-6 --max-iters 1000000
./build/heat_conduction --size 256 --optimized          # версия после оптимизации
./build/heat_conduction --size 10                       # печать 10×10
./scripts/verify_small.sh ./build/heat_conduction       # 10×10 и 13×13 для отчёта
```
